...
import { ones, twos, threes, fours, fives, sixes, threeOfKind, fourOfKind, fullHouse, smallStraight, largeStraight, diceRoller, chance } from './Rules';
        ...
        <section className='ScoreTable-section ScoreTable-section-lower'>
          ...
          <table cellSpacing='0'>
            <tbody>
              ...
              <RuleRow name='DiceRoller' score={scores.diceRoller} doScore={(evt) => doScore('diceRoller', diceRoller.evalRoll)} />
